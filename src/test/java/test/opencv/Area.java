...
public class Area {
	...
	public static void main(String[] args) {
		...
		Mat src = Imgcodecs.imread("/Users/hecj/Desktop/1.jpeg");
		Mat gray = new Mat();
		// 灰色
		Imgproc.cvtColor(src, gray, Imgproc.COLOR_BGR2GRAY);
		Imgcodecs.imwrite("/Users/hecj/Desktop/p31.jpeg", gray);
...
//	    Imgcodecs.imwrite("/Users/hecj/Desktop/p3111.jpeg", dilate);
	...
	public static Mat preprocess(Mat gray) {
		...
		Imgcodecs.imwrite("/Users/hecj/Desktop/dst.jpeg", sobel);
		// 2. 二值化
		Mat threshold = new Mat();
		...
		Mat element2 = Imgproc.getStructuringElement(Imgproc.MORPH_RECT, new Size(24, 6));
		Imgcodecs.imwrite("/Users/hecj/Desktop/element2.jpeg", element2);
		// 4. 膨胀一次，让轮廓突出
		Mat dilate = new Mat();
		Imgproc.dilate(threshold, dilate, element2);
