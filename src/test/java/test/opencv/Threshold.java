...
public class Threshold {
    ...
    public static void main(String[] args) {
        ...
        // 加载时灰度
        Mat src = Imgcodecs.imread("/Users/hecj/Desktop/WechatIMG182.jpeg", Imgcodecs.IMREAD_GRAYSCALE);
        // 保存灰度
...
//        Imgproc.threshold(src, target, 100, 255, Imgproc.THRESH_BINARY);//灰度图像二值化
        // 保存二值化后图片
        Imgcodecs.imwrite("/Users/hecj/Desktop/WechatIMG1822.jpeg", target);
//       
